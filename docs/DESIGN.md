...
> Design notes for **creator-marketplace-model-handoff** — a runnable typescript example that Route creator orders through active seller assets and hand generated copy back with its serving vendor.
...
- **Feature code** — the actual task: creator-order-handoff.
